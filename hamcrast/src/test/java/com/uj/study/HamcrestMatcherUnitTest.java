...
import static com.uj.study.IsPositiveInteger.isAPositiveInteger;
...
/**
 * @author ：unclejet
 * @date ：Created in 2020/1/31 8:07
 * @description：
 * @modified By：
 * @version:
 */
public class HamcrestMatcherUnitTest {
    ...
    public void givenBean_whenHasCorrectValue_thenCorrect() {
        Person person = new Person("Baeldung", "New York");
        assertThat(person, HasPropertyWithValue.hasProperty("address", equalTo("New York")));
    }
